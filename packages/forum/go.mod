module github.com/forumline/forumline/forum
...
require (
	...
	// github.com/oapi-codegen/runtime v1.2.0 -- now direct dep above
...
replace github.com/forumline/forumline/backend => ../backend
